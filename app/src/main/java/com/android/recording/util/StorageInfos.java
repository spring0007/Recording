...
public class StorageInfos {
    ...
    public static boolean isInternalStorageMounted() {
        String state = Environment.getExternalStorageState(); //.getInternalStoragePathState();
    ...
    public static File getInternalStorageDirectory() {
        return Environment.getExternalStorageDirectory();//getInternalStoragePath();
    }
    ...
    public static boolean isExternalStorageMounted() {
        String state = Environment.getExternalStorageState();//getExternalStoragePathState();
        return Environment.MEDIA_MOUNTED.equals(state);
    }
    ...
    public static File getExternalStorageDirectory() {
        return Environment.getExternalStorageDirectory();//getExternalStoragePath();
    }
