...
import com.android.recording.RecordService;
...
//      requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initializeList(){
        String sdState = StorageInfos.getExternalStorageDir();//Environment.getExternalStoragePathState();
        String internalState = StorageInfos.getExternalStorageDir();//Environment.getInternalStoragePathState();
        File internalPath = StorageInfos.getInternalStorageDirectory();//Environment.getInternalStoragePath();
        File externalPath = StorageInfos.getExternalStorageDirectory();//Environment.getExternalStoragePath();
