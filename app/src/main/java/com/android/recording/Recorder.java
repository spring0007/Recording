...
/* @} */
    ...
    private void doStartRecording(int outputFileFormat) {
        ...
        // Handle IOException
        try {
            Log.d(TAG, "setMaxFileSize " + maxSize);
            ...
            mRecorder.setOnInfoListener(new OnInfoListener() {
                ...
                public void onInfo(MediaRecorder mr, int what, int extra) {
                    if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
                        ...
                        if(mState == RECORDING_STATE){
                            Log.d(TAG, "MEDIA_RECORDER_INFO_MAX_FILESIZE_REACHED 4");
        ...
        public void onAudioFocusChange(int focusChange) {
            ...
            case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                if (mPlayer == null && mRecorder == null){
                    ...
                    try {
                        Thread.sleep(1300);//bug 629505
                    } catch (Exception e) {
                    }
                    if(audioManager.isMusicActive() || audioManager.isStreamMute(AudioManager.STREAM_RING)/* AudioSystem.isStreamActive(AudioSystem.STREAM_RING ,0)
                        || AudioSystem.isStreamActive(AudioSystem.STREAM_NOTIFICATION,0)*/){//water:Lqq
